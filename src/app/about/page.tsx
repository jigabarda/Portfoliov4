    ...
    <div className="mx-6 lg:mx-20 xl:mx-50 2xl:mx-100">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 auto-rows-auto items-stretch">
        ...
        <div className="bg-white/5 p-4 rounded-md flex flex-col gap-3 lg:col-span-2">
          ...
          <h4 className="text-sm text-gray-400">Full Stack Developer</h4>
          <p className="text-gray-300 text-sm">Philippines 🇵🇭</p>

          <div className="flex gap-3 mt-3 text-sm">
            <button className="bg-[#A30000]/20 text-[#A30000] px-4 py-2 rounded-full">
              Schedule Meeting
            </button>
            <button className="bg-white/10 text-white px-4 py-2 rounded-full">
              Send Email
            </button>
          </div>
        </div>
